      ...
      <div className="container flex justify-between items-center py-2">
        ...
        <div className="flex gap-2.5 items-center">
          ...
          <div className="hidden md:block">
            <Button href={isAboutPage ? "/#pricing" : "#pricing"}>
      ...
      >
        <div className="container py-3">
          <nav className="flex flex-col gap-3">
            {navItems.map((item) => (
              <Link
                key={item.href}
                href={item.href}
                className="block px-2 py-2 rounded-md transition-colors duration-200 text-white/90 hover:text-white hover:bg-white/10"
          ...
          <div className="flex gap-2 mt-3">
            ...
            <div>
              <Button
                href={isAboutPage ? "/#pricing" : "#pricing"}
                onClick={() => setMenuOpen(false)}
              >
                {lang === "ar" ? "سجل الآن" : "Register Now"}
              </Button>
