...
export default function Hero({ lang }: HeroProps) {
  const content =
    lang === "ar"
      ? {
          title: "ابدأ اليوم وكن قائدًا تقنيًا سيشكل مستقبل الغد",
          subtitle: "فكر. برمج. ابتكر",
          bullets: [
            "حصص برمجة مباشرة عبر الإنترنت بحضور فردي",
            "مناهج معتمدة على مشروعات واقعية",
            "أفضل المدربين، في راحة منزلك",
          ],
